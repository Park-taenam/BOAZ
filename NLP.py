...
def WordDictionary():
    ...
    total = ['사이즈', '사이즈하', '사이즈감', '임사이즈', '여사이즈', '사이즌', '뻐요사이즈', '싸이즈', '핏이', '핏', '핏입니다',
             ...
             '핏입니', '핏이라서', '핏으로', '옷핏', '핏도', '핏감', '옷', '후드', '후드티', '핏은', '좋아요핏', '요핏도',
             '좋아요핏도', '상의', '요핏', '폼', '폭', '사이즈', '후드', '옷', '품', '전체', '품도', '몸통', '옷핏', '핏',
             '핏이구', '핏이었', '핏임', '핏입', '핏입니', '핏감', '요핏', '폼', '후드핏', '핏이', '크기', '상품', '상의']
    ...
    big = ['큰', ' 긴', '커요', '크고', '크긴', '넉넉하고', '길어서', '넉넉하게', '작다는'
           ...
           '헐렁', '길긴', '와이드하', '아방해서', '세미오버사이즈', '널', '덮', '넓', '벙벙하', '덮이', '덮히', '커다랗', '덥히', '넉넉해지', '뒤집'
           '넉넉']
...
if __name__=="__main__":
    ...
    data.to_pickle('./data/data_review_preprocessing_done.pkl')